  ...
  <div
    ...
    <div id="modal" class="bg-white t-56 mt-auto mx-auto p-4 border-1 border-gray-50 w-2/3 rounded-md shadow-md">
      ...
      <div class="flex flex-col justify-between items-center divide-y-1 p-4 gap-4 my-2 font-captainlight text-center">
        ...
        <p class="text-xs md:text-md"> Welcome to my porfolio and thanks for visiting !</p>
        <p class="text-xs md:text-md"> All my photographs were shot on 35mm film in various places around the world. All photos are available to be printed in different formats on cotton paper of great quality.</p>
        <p class="text-xs md:text-md"> <span class="italic">Curious ?</span> Take a look at <span class="underline decoration-3 cursor-pointer hover:font-bold" @click="navigateToGallery">the final result</span> in the home of the people who took the plunge.</p>
