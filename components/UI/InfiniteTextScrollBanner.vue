<template>
  <div class="overflow-y-hidden w-full border-black bg-black pb-1 border-b border-x rounded-b-xl bg-white">
    <div class="w-full overflow-hidden whitespace-nowrap bg-white rounded-t-none rounded-b-md shadow-md">
      <div
