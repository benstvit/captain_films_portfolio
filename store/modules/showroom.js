export default {
  ...
  actions: {
    async fetch({ commit }) {
      let photos = []
      const {data, status } = await this.$axios.get("https://www.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=6fbbbf8a9d5ff41558c9100d42279af6&photoset_id=72177720305812757&user_id=184230567%40N04&format=json&nojsoncallback=1")
      if (status === 200) {
